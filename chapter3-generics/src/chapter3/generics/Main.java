...
public class Main {
	...
	public static void runGenericStack() throws DataListOverFlowException {
		...
		// Generic yapılarda primitive veri tipi kullanılmaz!
		// Stack<int> primitiveIntStack = new Stack<int>(10);
	...
	public static void runGenericQueue() throws DataListOverFlowException {
		...
		Queue<String> longQueue = new Queue<String>(10);
		
		longQueue.push("Ali");
		longQueue.push("Ayşe");
		longQueue.push("Ahmet");
		longQueue.push("Merve");
		
		longQueue.print();
		
		
		String firstItem = longQueue.pop();
	...
	public static void runGenericSuperLowerBound() {
		...
		bookList.add(new Book("Python Kitabı",9));
